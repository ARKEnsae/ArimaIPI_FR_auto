...
{[}\emph{Question 6}{]} En somme, la région de confiance pour \((X_{T+1},X_{T+2})\) est l'ellipse :
...
{[}\emph{Question 8}{]} Le graphique \ref{fig:RegIC} présente la région de confiance au seuil 95 \%, que les intervalles de confiance associés aux deux prévision montre cette région de confiance au seuil 95 \%, ainsi qu'à titre de comparaison les valeurs réelles de l'IPI automobile de janvier et de février 2020.
...
\item
  ...
  Cette incertitude se traduit par un intervalle de confiance très grand\footnote{On prévoit une évolution mensuelle entre décembre 2019 et janvier 2020 comprise entre -6,8 \% et +8,7 \%, ce qui est très grand compte tenu de la volatilité de la série (l'écart-type de la série en évolution est de 4,1 et sa moyenne de 0,1).} et une rapide augmentation de cet intervalle.
\end{itemize}
