...
En prenant bien le soin de choisir \(X_t\) et \(Y_t\) de manière à ce que \((Y_t',X_t')'\) soit stationnaire, vérifier que \(Y_{T+1}\) permet d'améliorer la prévision de \(X_{T+1}\) revient alors à tester la condition suivante après avoir estimé les modèles correspondants :
