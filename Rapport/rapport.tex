...
{[}\emph{Question 6}{]} En somme, la région de confiance pour \((X_{T+1},X_{T+2})\) est une ellipse, dont le centre est \((\widehat X_{T+1\vert T}, \widehat X_{T+2\vert T})\) et caractérisé par l'équation :
