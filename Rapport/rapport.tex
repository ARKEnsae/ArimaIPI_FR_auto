...
\]
En remplaçant \(\sigma_h\) par \(\hat\sigma_h\), \(\theta_1\) par \(\theta_2\), les intervalles de confiance définis dans l'équation \eqref{eq:icCourtTerme} restent valides mais \textbf{asymptotiquement uniquement}.
