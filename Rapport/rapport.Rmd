...
Pour obtenir ces intervalles de confiance il faut que $T$ grand (dans notre cas $T=120$) et que les résidus de notre modèle ARIMA soient **indépendants, homoscédastiques et suivent une loi normale** : ce qui a bien été vérifié dans la partie précédente. 
